// Used https://jvilk.com/MakeTypes/ to autogenerate interfaces for MicrosoftProduct.
...
interface Properties1 {
  ...
  XboxXPA: boolean;
  BundledSkus?: Array<BundledSkusEntity> | null;
...
export interface BundledSkusEntity {
  BigId: string;
  DisplayRank: number;
  IsPrimary: boolean;
