...
export const AddEventPage: FC<{}> = () => <div>Do this later if i want</div>;

/*
  TODO: this is somehwat old code
  dont really feel like fixing during this refactor
  if I want to do schedule stuff later then fix
  otherwise delete eventually
*/
