const flashcardContents = [
  ...
  },
  {
    ...
    back: `**Answer:** \`row\` || \`row-reverse\` will run along the row in the **inline** direction`,
  },
  {
    front: `**Question:** Which direction does \`flex-direction: column || column-reverse\` run?`,
    back: `**Answer:** \`column\` || \`column-reverse\` will run along the column in the **block** direction`,
  },
  {
  ...
  },
  {
    ...
    back: `**Answer:** Set the value of the area's container to \`display: flex || inline-flex\``,
  },
  {
